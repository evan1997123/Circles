                ...
                circleList.forEach(circleID => {
                    firestore
                        ...
                        .then(doc => {
                            ...
                            var newNumberOfPeople = Object.keys(newLeaderList).length + Object.keys(newMemberList).length - 1;
                            ...
                            newRewardsHistoryForUsers = Object.keys(newRewardsHistoryForUsers).filter(keyUserID => {
                                if (keyUserID === userID) {
                                    return false
                                } else {
                                    return true;
